#!/usr/bin/env python3
"""
Evaluate trained Logistic Regression classifier on the held-out test set.
...
def main():
    print("=" * 70)
    print("Logistic Regression Classifier - Test Set Evaluation")
    print("=" * 70)
    ...
    if not MODEL_PATH.exists():
        raise FileNotFoundError(
            ...
            "Run 05_train_baseline_linear_classifier.py first."
        )
    ...
    print(f"C: {model_metadata.get('hyperparameters', {}).get('C', 'unknown')}")
