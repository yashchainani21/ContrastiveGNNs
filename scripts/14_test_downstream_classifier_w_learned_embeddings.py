...
print(f"Loaded downstream classifier from {DOWNSTREAM_CLF}")
...
print(f"Using {'pre-projection' if use_preproj else 'projection'} embeddings for evaluation")
...
print(f"Downstream classifier on test set: AUPRC={auprc:.4f}, ROC-AUC={rocauc:.4f}")
