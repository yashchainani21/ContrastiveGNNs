...
PROJ_DIM = 512
SEED = 42
SUBSET_SIZE = 100000  # total number of datapoints to train on
...
print("Subset stats:",
      "pos =", int((labels_all[sel_idx] == 1).sum()),
      "neg =", int((labels_all[sel_idx] == 0).sum()),
      "total =", len(sel_idx))
...
for epoch in range(1, EPOCHS + 1):
    ...
    if steps == 0:
        ...
        auprc = evaluate_linear_probe(model, eval_loader, device)
